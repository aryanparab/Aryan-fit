...
function Headerr(props){
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <p className='text-sm sm:text-bas mx-auto'>{description}</p>
    </div>
  )
}
...
export default function Generator(props) {
  ...
  return (
   ...
   <Headerr index={'01'} title={'Pick Your Poison'} description={'Select the workout you wish to endure'} />
    ...
    <Headerr index={'02'} title={'Lock on targets'} description={'Select the muscles judged for annihilation'} />
    ...
    <Headerr index={'03'} title={'Become Juggernaut'} description={'Select your ultimate objective!'} />
